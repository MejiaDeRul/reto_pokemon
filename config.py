...
# Configguraciones para la aplicacion
class Config():
    ...
    MAIL_SERVER = os.environ.get('EMAIL_SERVER') # Servidor del correo usado para enviar correos (outlook)
    MAIL_PORT = os.environ.get('EMAIL_PORT') # Puerto para enviar los correos
